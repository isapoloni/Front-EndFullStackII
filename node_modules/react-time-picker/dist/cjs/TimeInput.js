...
var Hour12Input_1 = __importDefault(require("./TimeInput/Hour12Input"));
var Hour24Input_1 = __importDefault(require("./TimeInput/Hour24Input"));
var MinuteInput_1 = __importDefault(require("./TimeInput/MinuteInput"));
var SecondInput_1 = __importDefault(require("./TimeInput/SecondInput"));
var NativeInput_1 = __importDefault(require("./TimeInput/NativeInput"));
var AmPm_1 = __importDefault(require("./TimeInput/AmPm"));
...
function TimeInput(_a) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (nextValue) {
            setAmPm((0, dates_1.convert24to12)((0, date_utils_1.getHours)(nextValue))[1]);
    ...
    var placeholder = format ||
        (function () {
            ...
            return formatTime(locale, date)
                ...
                .replace(new RegExp((0, utils_1.getAmPmLabels)(locale).join('|')), 'a');
        })();
    ...
    function onChangeExternal() {
        ...
        if (formElementsWithoutSelect.every(function (formElement) { return !formElement.value; })) {
            ...
            var hour_1 = Number(values.hour24 ||
                (values.hour12 && values.amPm && (0, dates_1.convert12to24)(values.hour12, values.amPm)) ||
                0);
    ...
    function onChange(event) {
        ...
        switch (name) {
            case 'amPm':
                ...
                break;
            case 'hour12':
                setHour(value ? (0, dates_1.convert12to24)(value, amPm || 'am').toString() : '');
                break;
            case 'hour24':
                setHour(value);
                break;
    ...
    function renderHour12(currentMatch, index) {
        ...
        return (react_1.default.createElement(Hour12Input_1.default, __assign({ key: "hour12" }, commonInputProps, { amPm: amPm, ariaLabel: hourAriaLabel, 
    ...
    function renderHour24(currentMatch, index) {
        ...
        var showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
        return (react_1.default.createElement(Hour24Input_1.default, __assign({ key: "hour24" }, commonInputProps, { ariaLabel: hourAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderMinute(currentMatch, index) {
        ...
        var showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
        return (react_1.default.createElement(MinuteInput_1.default, __assign({ key: "minute" }, commonInputProps, { ariaLabel: minuteAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderSecond(currentMatch, index) {
        ...
        return (react_1.default.createElement(SecondInput_1.default, __assign({ key: "second" }, commonInputProps, { ariaLabel: secondAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderAmPm(currentMatch, index) {
        return (react_1.default.createElement(AmPm_1.default, __assign({ key: "ampm" }, commonInputProps, { ariaLabel: amPmAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderNativeInput() {
        return (react_1.default.createElement(NativeInput_1.default, { key: "time", ariaLabel: nativeInputAriaLabel, disabled: disabled, maxTime: maxTime, minTime: minTime, name: name, onChange: onChangeNative, required: required, value: value, valueType: valueType }));
    }
    return (
