...
import {
  ...
  useUncontrolledProp,
  useWillUnmount
} from "./chunk-MORU3L3V.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
  EXITING
} from "./chunk-3BUCJI5W.js";
import {
  require_jsx_runtime
} from "./chunk-JLMSFIMF.js";
import {
  require_prop_types
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react13.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context6 = (0, import_react18.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var context5 = React35.createContext(null);
...
var FormGroup = React46.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormRange = React48.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React49.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React50.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React51.forwardRef((props, ref) => (0, import_jsx_runtime47.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React52.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var Modal = (0, import_react37.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime60.jsx)(import_jsx_runtime61.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime62.jsxs)(import_jsx_runtime61.Fragment, {
...
var AbstractModalHeader = React67.forwardRef(({
  ...
  const context6 = (0, import_react38.useContext)(ModalContext_default);
...
var Modal2 = React69.forwardRef(({
  ...
  const renderBackdrop = (0, import_react39.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react44.useMemo)(function() {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime87.jsxs)(import_jsx_runtime86.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react52.cloneElement)(children, triggerProps), (0, import_jsx_runtime85.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react54.useContext)(TabContext_default);
  if (!context6)
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime105.jsx)(import_jsx_runtime104.Fragment, {});
};
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime107.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastHeader = React105.forwardRef(({
  ...
  const context6 = (0, import_react56.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
