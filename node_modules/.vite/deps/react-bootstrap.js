import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-IFKH3GAH.js";
import {
  Container_default
} from "./chunk-HVSSATSY.js";
import {
...
var Button = React14.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames12.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && disabled && "disabled")
  });
});
...
function useForceUpdate() {
  var _useReducer = (0, import_react8.useReducer)(function(state) {
    return !state;
...
function Dropdown({
  ...
  const context5 = (0, import_react16.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var Feedback = React36.forwardRef(
  ...
  ({
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime32.jsx)(Component2, {
    ...props,
    ref,
...
var FormCheckLabel = React39.forwardRef(({
  ...
  return (0, import_jsx_runtime34.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React40.forwardRef(({
  ...
  const input = (0, import_jsx_runtime35.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime35.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime35.jsx)("div", {
      ...
      children: children || (0, import_jsx_runtime37.jsxs)(import_jsx_runtime36.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime35.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime35.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormGroup = React42.forwardRef(({
  ...
  const context5 = (0, import_react25.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React43.forwardRef(({
  ...
  return (
    ...
    (0, import_jsx_runtime40.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var NavbarOffcanvas = React66.forwardRef((props, ref) => {
  const context5 = (0, import_react36.useContext)(NavbarContext_default);
...
var Navbar = React67.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react37.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react37.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime64.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var Overlay = React69.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react39.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  const overlayRef = (0, import_react40.useRef)(null);
  const popoverClass = useBootstrapPrefix(void 0, "popover");
  const offset2 = (0, import_react40.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React72.forwardRef(({
  ...
  const popperRef = (0, import_react41.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react41.useState)(null);
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react42.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react42.useRef)("");
  ...
  const handleShow = (0, import_react42.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react42.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react42.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react42.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react42.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react42.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react42.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime72.jsxs)(import_jsx_runtime71.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react42.cloneElement)(children, triggerProps), (0, import_jsx_runtime70.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React74.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React74.forwardRef(({
    children,
    ...props
...
var Pagination = React75.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime75.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames51.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames52.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React76.forwardRef((props, ref) => {
...
var Placeholder = React77.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var Ratio = React79.forwardRef(({
  ...
  return (0, import_jsx_runtime79.jsx)("div", {
    ...
    children: React79.Children.only(children)
  });
});
...
var Spinner = React81.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React82.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime83.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime82.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime82.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react44.useContext)(TabContext_default);
  if (!context5)
...
var TabPanel = React84.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime90.jsx)(import_jsx_runtime89.Fragment, {});
};
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime92.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React91.forwardRef((props, ref) => (0, import_jsx_runtime94.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React92.createContext({
...
var ToastHeader = React93.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context5 = (0, import_react46.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React94.forwardRef(({
  ...
  const delayRef = (0, import_react47.useRef)(delay);
  ...
  const autohideFunc = (0, import_react47.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react47.useMemo)(() => ({
    onClose
  }), [onClose]);
...
var ToggleButton = React96.forwardRef(({
  ...
  return (0, import_jsx_runtime101.jsxs)(import_jsx_runtime100.Fragment, {
    children: [(0, import_jsx_runtime99.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime99.jsx)(Button_default2, {
      ...props,
      ref,
